...
@IonicPage()
@Component({
  selector: 'page-normal-bill',
  templateUrl: 'normal-bill.html',
})
export class NormalBillPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad AdminAddUserPage',this.navParams.data);
  ...
  {
    this.navCtrl.push('ModeDetailPage',{item:item,type:'normal'});
